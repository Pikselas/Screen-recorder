...
# CONTROL PANEL #
def ControlPanel():
    sizes = str(pyautogui.size())
    sizes = sizes.replace("Size","")
    sizes = sizes.replace("width","")
    sizes = sizes.replace("height","")
    sizes = sizes.replace("=","")
    sizes = sizes.replace("(","")
    sizes = sizes.replace(")","")
    sizes = sizes.replace(" ","")
    ...
    Width = ui.StringVar(window)
    Height = ui.StringVar(window)
    viewPortWidth = ui.Entry(window,textvariable = Width)
    viewPortHeight = ui.Entry(window,textvariable = Height)
